      ...
      >
        <div className="mt-[20vh]">
          ...
          <div className="flex justify-center  mt-[30vh]">
            <Link
              href={"/game"}
              className="animate-fade animate-once animate-delay-1000 transition-all duration-500 border border-gray-500 bg-gray-800 bg-opacity-80 text-white rounded-full shadow px-16 py-4 scale-125 focus:shadow focus:shadow-gray-500"
            >
              Comenzar
            </Link>
          </div>
